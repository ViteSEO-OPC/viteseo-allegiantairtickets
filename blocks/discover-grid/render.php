...
<section id="<?php echo esc_attr($instance_id); ?>"
  ...
  aria-label="<?php echo esc_attr($aria_label); ?>" data-per-page="<?php echo esc_attr($posts_per_page); ?>">
  ...
  <header class="discover-grid__head">
    ...
    <?php if ($show_search): ?>
      <div class="discover-grid__search-wrap">
        <input type="search" class="discover-grid__search" placeholder="<?php esc_attr_e('Search posts…', 'child'); ?>">
      </div>
    <?php endif; ?>
  </header>
    ...
    <div class="discover-grid__filters">
      <div class="discover-grid__categories-wrap">
        <div class="discover-grid__categories">
          <button type="button" class="discover-grid__cat-btn is-active" data-cat="all">
            <?php esc_html_e('Show All', 'child'); ?>
          </button>
          <?php foreach ($category_map as $slug => $name): ?>
            <button type="button" class="discover-grid__cat-btn" data-cat="<?php echo esc_attr($slug); ?>">
  ...
  <div class="discover-grid__grid" style="<?php echo esc_attr($grid_style); ?>">
    ...
    <?php foreach ($items as $item): ?>
      ...
      <?php if ($image_mode): ?>
        <article class="dg-card dg-card--images" data-post-id="<?php echo esc_attr($item['post_id']); ?>"
          data-title="<?php echo esc_attr($search_title); ?>" data-cats="<?php echo esc_attr($data_cats); ?>"
          data-modal-title="<?php echo esc_attr($display_title); ?>"
          data-modal-excerpt="<?php echo esc_attr($excerpt_safe); ?>"
          data-modal-author="<?php echo esc_attr($author_name); ?>" data-modal-likes="<?php echo esc_attr($likes); ?>"
          data-modal-liked="<?php echo $item['liked_by_user'] ? '1' : '0'; ?>" data-modal-url="<?php echo esc_url($url); ?>"
          data-modal-img="<?php echo esc_url($img); ?>" data-modal-download="<?php echo esc_url($download_url); ?>">

          <div class="dg-card__inner">
            <button type="button" class="dg-card__image-btn">
              <div class="dg-card__image">
                <?php if ($img): ?>
                  <img src="<?php echo esc_url($img); ?>" alt="<?php echo esc_attr($display_title); ?>">
                <?php else: ?>
            ...
            <div class="dg-card__body dg-card__body--images">
              <div class="dg-card__top-row">
                ...
                <a href="<?php echo esc_url($download_url); ?>" class="dg-card__download-icon" download>
      ...
      <?php else: ?>
        <article class="dg-card" data-title="<?php echo esc_attr(strtolower($title_safe)); ?>"
          data-cats="<?php echo esc_attr($data_cats); ?>" data-post-id="<?php echo esc_attr($item['post_id']); ?>"
          data-url="<?php echo esc_url($url); ?>" data-liked="<?php echo $item['liked_by_user'] ? '1' : '0'; ?>"
          data-likes="<?php echo esc_attr($likes); ?>">
          <div class="dg-card__inner">

            <div class="dg-card__thumb-wrap">
              <div class="dg-card__top-actions">
                <button type="button" class="dg-card__like-btn"
                ...
                <div class="dg-card__more">
                  ...
                  <div class="dg-card__more-menu" role="menu">
                    <a href="<?php echo esc_url($download_url); ?>" class="dg-card__pill dg-card__pill--download" download
                      role="menuitem">
                      <i class="fa-solid fa-download" aria-hidden="true"></i>
                      <?php esc_html_e('Download', 'child'); ?>
                    </a>
                    <button type="button" class="dg-card__pill dg-card__pill--share"
                      data-share-url="<?php echo esc_url($url); ?>" data-share-title="<?php echo esc_attr($title_safe); ?>"
                      role="menuitem">
              ...
              <div class="dg-card__image">
                <?php if ($img): ?>
                  <img src="<?php echo esc_url($img); ?>" alt="<?php echo esc_attr($title_safe); ?>">
                <?php else: ?>
                  <div class="dg-card__image-placeholder"></div>
                <?php endif; ?>
              </div>
        ...
        <div class="discover-grid__modal-inner">
          <div class="discover-grid__modal-media">
            <div class="discover-grid__modal-image-wrap">
              ...
              <a href="" class="discover-grid__modal-download" download>
                <i class="fa-solid fa-download" aria-hidden="true"></i>
                <span class="screen-reader-text">
                  <?php esc_html_e('Download image', 'child'); ?>
                </span>
